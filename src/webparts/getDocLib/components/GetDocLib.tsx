...
import styles from './GetDocLib.module.scss';
import { IGetDocLibProps } from './IGetDocLibProps';
...
export interface IGetDoclibState {
  items: IFile[];
  errors: string[];
}


export default class GetDocLib extends React.Component<IGetDocLibProps, IGetDoclibState> {
  private LIBRARY_NAME = "Documents";
  private _sp: SPFI;

  constructor(props: IGetDocLibProps) {
    super(props);
    // set initial state
    this.state = {
      items: [],
